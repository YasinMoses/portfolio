...
function Project(
    ...
    return (
    <section className='group bg-gray-100 max-w-[42rem] border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-2 sm:mb-8 last:mb-0 even:pl-8
    hover:bg-gray-200 transition'>
      ...
      <Image src={imageUrl} alt="Project" quality={95} className='absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl 
      transition
      group-hover: scale-[1.04]
      group-hover:-translate-x-3
      group-hover: trandlate-y-3
      group-hover:-rotate-2

      group-even:group-hover:translate-x-3
      group-even:group-hover: trandlate-y-3
